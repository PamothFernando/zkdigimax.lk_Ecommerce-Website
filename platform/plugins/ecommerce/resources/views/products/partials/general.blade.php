...
@if (
    ...
    @if($product && $product->generate_license_code && $product->license_code_type === 'pick_from_list' && EcommerceHelper::isEnabledLicenseCodesForDigitalProducts())
                            ...
                            <x-core::table.body.cell>
                                @if($licenseCode->assigned_at && $licenseCode->assignedOrderProduct && $licenseCode->assignedOrderProduct->order)
                                    <div>
                                        ...
                                        <br>
                                        <a href="{{ route('orders.show', $licenseCode->assignedOrderProduct->order->id) }}"
                                           class="text-primary"
                                           target="_blank">
                                            <x-core::icon name="ti ti-external-link" />
